...
|--------------------|-------------------------------------|-----------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------|
| **Activation**     | (0 ↔ 1)                             | Void (0) + Observer (1)                       | Triggers new tasks or explorations by linking raw potential (Void) with perceptual awareness (Observer), initiating early-stage data collection and analysis.                                                               | **Kether**                          |
| **Differentiation**| (0 ↔ 2)                             | Void (0) + Subjects & Objects (2)             | Converts unstructured novelty from the Void into recognizable forms and relationships through parsing and classification.                                                                                   | **Geburah**                         |
| **Affinity**       | (1 ↔ 2)                             | Observer (1) + Subjects & Objects (2)         | Evaluates synergy or conflict between perceived data (Observer) and structured entities (S&O), helping refine or flag potential issues for further investigation.                                                        | **Chesed**                          |
| **Illumination**   | (0 ↔ ∞)                             | Void (0) + Blueprint (∞)                      | Filters and decides which creative or random inputs from Void should be elevated into the global knowledge base, turning raw innovation into recognized insights.                                                             | **Chokmah (The Wisdom)**            |
| **Understanding**  | (1 ↔ ∞)                             | Observer (1) + Blueprint (∞)                  | Provides ethical alignment and feedback, ensuring beneficial patterns are rewarded and user values remain a top priority during the system’s decision-making processes.                                                      | **Binah (The Understanding)**       |
| **Discernment**    | (2 ↔ ∞)                             | Subjects & Objects (2) + Blueprint (∞)        | Analyzes complex data for inconsistencies or potential harm, guiding risk mitigation and imposing ethical gating when questionable outputs appear.                                                                            | **Tiphareth (The Beauty)**          |
| **Equilibrium**    | (2 ↔ 3)                             | Subjects & Objects (2) + Medium (3)           | Balances resources and mediates conflicts between structured data (S&O) and contextual processing (Medium), ensuring coherent, stable outcomes.                                                                               | **Yesod (The Foundation)**          |
| **Constitution**   | (1 ↔ 3)                             | Observer (1) + Medium (3)                     | Maintains resilience and fault tolerance by dynamically adjusting processes when anomalies surface, helping the system adapt to changing conditions.                                                                        | **Netzach (The Eternity)**          |
| **Emergence**      | (0 ↔ 3)                             | Void (0) + Medium (3)                         | Merges raw novelty (Void) with contextual logic (Medium) to generate innovative solutions or capabilities that evolve over time.                                                                                             | **Hod (The Glory)**                 |
| **Cohesion**       | (3 ↔ ∞)                             | Medium (3) + Blueprint (∞)                    | Integrates final outputs into the core knowledge base, ensuring emergent intelligence remains consistent with overarching goals and system-wide architecture.                                                                | **Malkuth (The Presence)**          |
